...
function resolveFieldOverrides(array $raumtyp, string $bauabschnitt = '', string $ebene = ''): array
{
    ...
    $geschirrreinigung = ['22'];
    if (in_array((string)($raumtyp['id'] ?? ''), $geschirrreinigung)) {
        $hidden[] = 'vibrationsempfindlich_bodenstehend';
        $hidden[] = 'explosionsschutz';
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'raumzuluft_besonders';
        $hidden[] = 'raumabluft_besonders';
        $hidden[] = 'kuehlwasser';

    }

    $klimakammer = ['13'];
    if (in_array((string)($raumtyp['id'] ?? ''), $klimakammer)) {
        $hidden[] = 'vibrationsempfindlich_bodenstehend';
        $hidden[] = 'explosionsschutz';
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'kuehlwasser';
    ...
    $sensorikraum = ['25'];
    if (in_array((string)($raumtyp['id'] ?? ''), $sensorikraum)) {
        $hidden[] = 'vibrationsempfindlich_bodenstehend';
        $hidden[] = 'explosionsschutz';
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'raumzuluft_besonders';
    ...
    if (in_array((string)($raumtyp['id'] ?? ''), ['1'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'raumabluft_besonders';
    }

    if (in_array((string)($raumtyp['id'] ?? ''), ['23'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'explosionsschutz';
        $hidden[] = 'nutzwasser';
        $hidden[] = 'kuehlwasser';
    ...
    if (in_array((string)($raumtyp['id'] ?? ''), ['24'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'explosionsschutz';
        $hidden[] = 'nutzwasser';
        $hidden[] = 'spezialabwasser';
    ...
    if (in_array((string)($raumtyp['id'] ?? ''), ['26'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'vibrationsempfindlich_bodenstehend';
        $hidden[] = 'raumzuluft_besonders';
        $hidden[] = 'raumabluft_besonders';
    ...
    if (in_array((string)($raumtyp['id'] ?? ''), ['27', '28'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'explosionsschutz';
        $hidden[] = 'vibrationsempfindlich_bodenstehend';
        $hidden[] = 'raumzuluft_besonders';
    ...
    if (in_array((string)($raumtyp['id'] ?? ''), ['29'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'N2';
        $hidden[] = 'DL';
        $hidden[] = 'Vakuum';
    ...
    if (in_array((string)($raumtyp['id'] ?? ''), ['30'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'N2';
        $hidden[] = 'DL';
        $hidden[] = 'Vakuum';
    ...
    if (in_array((string)($raumtyp['id'] ?? ''), ['16'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'N2';
        $hidden[] = 'DL';
        $hidden[] = 'Vakuum';
    ...
    if (in_array((string)($raumtyp['id'] ?? ''), ['12'])) {
        $hidden[] = 'abluftwaescher';
        $hidden[] = 'kuehlwasser';
    }
