...
<?php
        if(filter_input(INPUT_GET, 'deviceID') != ""){
            $_SESSION["deviceID"]=filter_input(INPUT_GET, 'deviceID');
        }
	...
	/*$sql = "SELECT tabelle_parameter.Bezeichnung, tabelle_geraete_has_tabelle_parameter.Wert, tabelle_geraete_has_tabelle_parameter.Einheit
			FROM tabelle_parameter INNER JOIN tabelle_geraete_has_tabelle_parameter ON tabelle_parameter.idTABELLE_Parameter = tabelle_geraete_has_tabelle_parameter.TABELLE_Parameter_idTABELLE_Parameter
	...
	echo "<table class='table table-striped table-sm' id='tableStandardDeviceParameters' cellspacing='0'>
	<thead><tr>
        <th>Kategorie</th>
	<th>Parameter</th>
	<th>Wert</th>
	...
	if($_SESSION["dbAdmin"]=="1"){
            echo "<input type='button' id='changeDeviceParametersButton' class='btn btn-warning btn-sm' value='Parameter bearbeiten' data-toggle='modal' data-target='#changeDeviceParameters'></input>";
	}
        else{
            echo "<button type='button' id='".$_SESSION["deviceID"]."' class='btn btn-default btn-sm' value='ParameterOvertake' data-toggle='modal' data-target='#parameterOvertakeModal'><span class='glyphicon glyphicon-open-file'></span> Parameter übernehmen</button>";
        }
	  ...
	  <div class='modal fade' id='parameterOvertakeModal' role='dialog'>
	    <div class='modal-dialog modal-sm'>
	      ...
	      <div class='modal-content'>
	        ...
	        <div class='modal-body' id='mbody'>Wollen Sie die Geräteparameter übernehmen? Alle gespeicherten Variantenparameter gehen verloren?
	        </div>
	        <div class='modal-footer'>
	        	<input type='button' id='saveParametersFromDevice' class='btn btn-success btn-sm' value='Ja' data-dismiss='modal'></input>
	      ...
	      <div class='modal-content'>
	        ...
	        <div class='modal-body' id='mbody'>
                    <form role="form">
						...
						echo "<table class='table table-striped table-sm' id='tablePossibleDeviceParameters' cellspacing='0'>
						<thead><tr>
						<th>ID</th>
						<th>Kategorie</th>
						<th>Parameter</th>
