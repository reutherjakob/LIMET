...
foreach ($teile as $valueOfRoomID) {
    ...
    $sql = "SELECT tabelle_räume.idTABELLE_Räume, tabelle_räume.Raumnr, tabelle_räume.Raumbezeichnung, tabelle_räume.`Raumbereich Nutzer`, tabelle_räume.Geschoss, tabelle_räume.Bauetappe, tabelle_räume.`Funktionelle Raum Nr`, tabelle_räume.`Raumtyp BH`, tabelle_räume.Raumhoehe, tabelle_räume.`Raumhoehe 2`, tabelle_räume.`Raumhoehe_Soll`,
            ...
            tabelle_räume.RaumNr_Bestand, tabelle_räume.Gebaeude_Bestand, tabelle_räume.`ET_EMV_ja-nein`, tabelle_räume.`EL_Leistungsbedarf_W_pro_m2`, tabelle_räume.`HT_Waermeabgabe`,  
            CAST(replace(tabelle_räume.`HT_Luftwechsel 1/h`, ',', '.') AS DECIMAL(14,2)) AS `HT_Luftwechsel 1/h`, tabelle_räume.`HT_Abluft_Sicherheitsschrank_Stk`, tabelle_räume.`HT_Kühlwasserleistung_W`,
            ...
            tabelle_räume.`PHY_Akustik_T500`, tabelle_räume.`PHY_Akustik_Schallgrad`, tabelle_räume.`Taetigkeiten`, tabelle_räume.`AP_Geistige`,
            tabelle_räume.`VEXAT_Zone`, tabelle_räume.`HT_Raumtemp Sommer °C`, tabelle_räume.`HT_Raumtemp Winter °C`, tabelle_räume.`LHe`, tabelle_räume.`EL_Not_Aus_Funktion`, tabelle_räume.`EL_Signaleinrichtung`,
            tabelle_räume.`Spezialgase`, tabelle_räume.`Gaswarneinrichtung-Art`, tabelle_räume.`HT_Luftmenge m3/h`
