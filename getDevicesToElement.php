...
<?php
	...
	echo "<input type='button' id='".$_SESSION["elementID"]."' class='btn btn-default btn-sm' value='Geräte vergleichen' data-toggle='modal' data-target='#deviceComparisonModal'></input>";
?>
...
<script>
	...
	$("#saveDevice").click(function(){
		...
		if(hersteller !== "" && type !== "" && kurzbeschreibung  !== ""){
		    ...
		    $.ajax({
		        url : "saveDevice.php",
		        data:{"deviceID":deviceID,"hersteller":hersteller,"type":type,"kurzbeschreibung":kurzbeschreibung},
		        type: "GET",	        
		        success: function(data){
                            alert(data);
                            $.ajax({
