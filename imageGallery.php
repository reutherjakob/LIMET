...
<div class="container-fluid">
    <div class='me-4 mt-4 row'>
        <div class='col-xxl-12'>
            <div class="mt-4 card">
                <div class="card-header"><b>Projektfotos </b>
                    <label class="float-right">
                        <button type='button' id='addImage' class='btn btn-outline-dark btn-sm' value='Bild hinzufügen'
                                style='visibility:visible'><i class='fas fa-plus'></i> Bild hinzufügen
                        </button>
                    </label>
                </div>
                <div class="card-body">
