...
<script>
    ...
    $("#saveRechnung").click(function () {
        if (id === 0) {
            ...
            let rechnungID = $("#rechnungID").val();
            let teilRechnungNr = $("#teilRechnungNr").val();
            let rechnungNr = $("#rechnungNr").val();
            let rechnungAusstellungsdatum = $("#rechnungAusstellungsdatum").val();
            let rechnungEingangsdatum = $("#rechnungEingangsdatum").val();
            let rechnungSum = normalizeCosts($("#rechnungSum").val());
            let rechnungBearbeiter = $("#rechnungBearbeiter").val();
    ...
    $("#addRechnung").click(function () {
        if (id === 0) {
            ...
            let rechnungSchlussrechnung;
            let rechnungID = $("#rechnungID").val();
            let teilRechnungNr = $("#teilRechnungNr").val();
            let rechnungNr = $("#rechnungNr").val();
            let rechnungAusstellungsdatum = $("#rechnungAusstellungsdatum").val();
            let rechnungEingangsdatum = $("#rechnungEingangsdatum").val();
            let rechnungSum = $("#rechnungSum").val();
            let rechnungBearbeiter = $("#rechnungBearbeiter").val();

            if ($("#rechnungSchlussrechnung").prop('checked') === false) {
                rechnungSchlussrechnung = 0;
            } else {
                rechnungSchlussrechnung = 1;
            }
