...
use const format_money_report0 as format_money_report0Alias;
...
class MYPDF extends TCPDF
{
    ...
    {
        if ($_SESSION["projectAusfuehrung"] === "MADER") {        // Logo
...
ob_end_clean();
$pdf->Output('NameOfTheGame.pdf', 'I');
