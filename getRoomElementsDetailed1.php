	...
	if (!$mysqli->set_charset("utf8")) {
        ...
        echo "<form class='form-inline'>
            <div class='form-group'>
                ...
                <input type='text' class='ml-4 mr-4 form-control input-xs' id='kosten_neu' value=".money_format("%i", $row["Summe_Neu"])." disabled='disabled'></input>
            </div>";
        ...
        echo "
                <div class='form-group'>
                    ...
                    <input type='text' class='ml-4 form-control input-xs' id='kosten_neu' value=".money_format("%i", $row["Summe_Bestand"])." disabled='disabled'></input>
                </div>						  			 											 						 			
           </div>	
           </form>";
	    ...
	    <div class='modal-dialog modal-lg'>
	      ...
	      <div class='modal-content'>
	        ...
	        <div class='modal-footer'>
	        	<input type='button' id='copyRoomElements' class='btn btn-info btn-sm' value='Elemente kopieren'></input>
