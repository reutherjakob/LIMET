...
<main class="container-fluid">
    ...
    <div class="mt-1 card">
        <div class="card-header d-flex border-light" style="height: 1vh; font-size: 3vh;" id="btnLabelz">
            ...
            <div class="col-md-2"><strong>Sichtbarkeit</strong></div>
            <div class="col-md-1 d-flex justify-content-end align-items-right "><strong>Neu & Output</strong></div>
            <div class="col-md-2 d-flex justify-content-end align-items-right"><strong>Check&Settings</strong></div>
        </div>
        <div class="card-header container-fluid d-flex align-items-start border-dark">
            <div class="col-md-3 d-flex justify-content-left    " id='TCH0'></div>
            <div class="col-md-1 d-flex justify-content-left    " id='TCH2'></div>
            <div class="col-md-1 d-flex justify-content-end     align-items-center" id="TCH3"></div>
            <div class="col-md-4 d-flex justify-content-center  align-items-center" id="TCH4"></div>
            <div class="col-md-1 d-flex justify-content-end     align-items-right" id='TCH5'></div>
            <div class="col-md-2 d-flex justify-content-end     align-items-right" id='TCH6'></div>
        </div>
        ...
        <div class="mt-4 card">
            <div class="card">
                <div class="card-header d-flex align-items-baseline">
                    <button type="button" class="btn btn-sm btn-outline-dark " id="showRoomElements"><i
                                class="fas fa-arrow-left"></i></button>
                    <label for="diy_searcher"></label><input type="text" class="pull-right btn-sm " id="diy_searcher"
                                                             placeholder="Search...">
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" id="settings_save_state" checked>
...
<script charset=utf-8>
    ...
    $(document).ready(function () {
        ...
        add_MT_rel_filter('#TCH0');
        add_entfallen_filter('#TCH0');
        move_dt_search();
    ...
    function init_MT_rel_filter() {
        setTimeout(function () {
            if ((document.getElementById('settings_save_state').checked || document.getElementById('settings_save_state_4all_projects').checked) && table.state.loaded()) {
                ...
                console.log("MT Rel Data", columnData);
    ...
    function init_btn_4_dt() {
        ...
        new $.fn.dataTable.Buttons(table, {buttons: searchbuilder}).container().appendTo($('#TCH2'));
        new $.fn.dataTable.Buttons(table, {buttons: buttons_group_selct}).container().appendTo($('<div class="btn-group"></div>').appendTo($('#TCH3')));
        new $.fn.dataTable.Buttons(table, {buttons: buttonsGroupcolumnVisbilities}).container().appendTo($('<div class="btn-group" role="group"></div>').appendTo($('#TCH4')));
        new $.fn.dataTable.Buttons(table, {buttons: btn_grp_new_out}).container().appendTo($('<div class="btn-group"></div>').appendTo($('#TCH5')));
        new $.fn.dataTable.Buttons(table, {buttons: btn_grp_settings}).container().appendTo($('<div class="btn-group"></div>').appendTo($('#TCH6')));
    }
    ...
    function toggleButtonTexts() {
        ...
        let btn_grp_new_out = [{titleAttr: "Add Room"}, {titleAttr: "Copy Selected Row"}, {titleAttr: "Download as Excel"}, {titleAttr: "Download PDF"}];
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelector('#settings_toggle_btn_texts').addEventListener('click', function () {
            toggleButtonTexts();
        });
    });
    ...
    function table_click() {
        $(document).on('click', '#table_rooms tbody tr', function () {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (!data || data.trim() === "") {
                                        ...
                                        tableElements = $('#myTable').DataTable();
                                    }
            ...
            $('#diy_searcher').on('keyup', function () {
                tableElements.search(this.value).draw();
            });
        });
    }
    ...
    function move_dt_search() {
        ...
        document.getElementById("TCH0").appendChild(dt_searcher);
