    ...
    <main class="container-fluid">
        ...
        <section class="mt-1 card">
            <header class="card-header d-flex border-light" style="height: 1vh; font-size: 1vh;" id="btnLabelz">
                ...
                <div class="col-md-2 d-flex justify-content-end align-items-right"><strong style="float: right;">Check&Settings</strong></div>
            </header>
...
<script charset=utf-8>
                        ...
                        function init_MT_rel_filter() {
                            setTimeout(function () {
                                if ((document.getElementById('settings_save_state').checked || document.getElementById('settings_save_state_4all_projects').checked) && table.state.loaded()) {
                                    var columnData = table.column("MT-relevant:name", {search: 'applied', order: 'applied', visible: true}).data().toArray();
                        ...
                        function init_btn_4_dt() {
                            ...
                            const btn_grp_settings = [
                                ...
                                {text: "", className: 'btn btn-light fas fa-cogs', titleAttr: "Open Settings", action: open_einstellung_modal}
                            ];
