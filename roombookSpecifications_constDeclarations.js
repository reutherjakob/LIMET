...
//    { data: '', defaultContent: '', title: "Select", render:  $.fn.dataTable.render.select(), searchable: false, orderable: false }, //cool, but buggy with fix columns. 
    ...
    {data: '', title: 'AV Anschlussleistung [W]',  case: "bit"},
    {data: '', title: 'SV Anschlussleistung [W]',  case: "bit"},
    {data: '', title: 'ZSV Anschlussleistung [W]',  case: "bit"},
    {data: '', title: 'USV Anschlussleistung [W]',  case: "bit"},
