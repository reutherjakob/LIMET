...
function get_titelblatt_logo($pdf)
{
    if ($_SESSION["projectAusfuehrung"] === "LIMET-MADER") {
        $image_file = 'LIMET_web.png';
        $pdf->Image($image_file, 145, 40, 30, 13, 'PNG', '', 'M', false, 300, '', false, false, 0, false, false, false);
        $image_file = 'MADER_Logo.png';
        $pdf->Image($image_file, 178, 42, 15, 13, 'PNG', '', 'M', false, 300, '', false, false, 0, false, false, false);
        $pdf->SetY(60);
        $pdf->SetX(110);
        ...
        $image_file = 'ARGE_LIMET-CFM_Logo_03.png';
        $pdf->Image($image_file, 130, 35, 60, 20, 'PNG', '', 'M', false, 300, '', false, false, 0, false, false, false);
    } else if ($_SESSION["projectAusfuehrung"] === "LIMET") {
        $image_file = 'LIMET_web.png';
        $pdf->Image($image_file, 150, 40, 30, 15, 'PNG', '', 'M', false, 300, '', false, false, 0, false, false, false);
    }
