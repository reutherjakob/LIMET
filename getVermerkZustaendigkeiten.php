...
<?php        
	...
	echo "<table class='table table-striped table-sm' id='tableVermerkZustaendigkeitMembers' cellspacing='0'>
        ...
        while($row = $result->fetch_assoc()) {
            echo "<tr>";						 
            echo "<td><button type='button' id='".$row["idTABELLE_Ansprechpersonen"]."' class='btn btn-danger btn-xs' value='deleteVermerkZustaendigkeit'><i class='fa fa-minus-circle'></i></button></td>";
            echo "<td>".$row["Name"]."</td>";
