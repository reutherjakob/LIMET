    ...
    <div class="mt-41 card">
        <div class="card-header">
            <div class="row">
                ...
                <div  class="col-6 d-inline-flex justify-content-end align-items-center" id="CardHeader"> &emsp; <i class='fas fa-hourglass-start'>=Vorher</i> &emsp;  <i class='fas fa-hourglass-end'>=Nachher</i> &emsp;</div>
            </div>
