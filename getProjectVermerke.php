<div class='table-responsive'>
    <table class='table table-striped table-bordered table-sm table-hover border border-light border-5'
        ...
        $filterValue = getPostInt('filterValue', 0);

        $stmt = $mysqli->prepare("SELECT tabelle_Vermerkgruppe.Gruppenname, tabelle_Vermerkgruppe.Gruppenart,
               tabelle_Vermerkgruppe.Ort, tabelle_Vermerkgruppe.Datum, tabelle_räume.Raumnr, tabelle_räume.Raumbezeichnung, 
               tabelle_lose_extern.LosNr_Extern, tabelle_lose_extern.LosBezeichnung_Extern, tabelle_ansprechpersonen.Name, 
               tabelle_ansprechpersonen.Vorname, tabelle_Vermerke.Faelligkeit, tabelle_Vermerke.Vermerkart,
               tabelle_Vermerke.Bearbeitungsstatus, tabelle_Vermerke.Vermerktext, tabelle_Vermerke.Erstellungszeit,
            ...
            WHERE tabelle_Vermerkgruppe.tabelle_projekte_idTABELLE_Projekte=? " . ($filterValue == 1 ? "AND tabelle_Vermerke.Vermerkart='Bearbeitung' AND tabelle_Vermerke.Bearbeitungsstatus='0'" : "") . "
