...
<?php        
	...
	$sql = "SELECT tabelle_ansprechpersonen.idTABELLE_Ansprechpersonen, tabelle_ansprechpersonen.Name, tabelle_ansprechpersonen.Vorname
        ...
        while($row = $result->fetch_assoc()) {
            echo "<tr>";
            echo "<td><button type='button' id='".$row["idTABELLE_Ansprechpersonen"]."' class='btn btn-success btn-xs' value='addVermerkZustaendigkeit'><i class='fas fa-plus-square'></i></button></td>";
            echo "<td>".$row["Name"]."</td>";
