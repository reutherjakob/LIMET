          ...
          <ul class="navbar-nav">
            ...
            <li class="py-0 nav-item dropdown">
              ...
              <ul class="dropdown-menu">                  
                  <a class="dropdown-item active" href="projects.php"><i class='fa fa-list-alt'></i> Projektauswahl</a> 
                  <?php 
                        if($_SESSION["ext"]==0){
            ...
            <ul class='navbar-nav'>
                <li class='nav-item'><a class='py-0 nav-link' href='imageGallery.php'><i class='fas fa-camera'></i> Fotos</a></li>
            </ul>
