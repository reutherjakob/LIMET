...
foreach ($teile as $valueOfRoomID) {
    ...
    while ($row = $result2->fetch_assoc()) { 
        ...
        if(strlen($row['Belichtungsfläche']) > 0){
            $pdf->MultiCell(25, 6, $row['Belichtungsfläche']." m2",0, 'L', 0, 0); 
        }        
        else{
            $pdf->MultiCell(25, 6, "",0, 'L', 0, 0); 
        }
        ...
        if(strlen($row['Raumhoehe 2']) > 0){
            $pdf->MultiCell(25, 6, $row['Raumhoehe 2']." m",0, 'L', 0, 0);
        }   
        else{
            $pdf->MultiCell(25, 6, "",0, 'L', 0, 0);
        }
        ...
        $pdf->SetFont('helvetica', '', 10);
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "Aufenthaltsraum: ",0, 'R', 0, 0);
        if($row['Aufenthaltsraum']==='0'){
            $pdf->SetFont(zapfdingbats, '', 10);
            $pdf->MultiCell(40, 6, TCPDF_FONTS::unichr(54),0, 'L', 0, 0);
        }
        else{
        ...
        $pdf->Ln();
        $pdf->MultiCell(76, 6, "SSD:",0, 'R', 0, 0);        
        if($row['EL_AV Steckdosen Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_AV Steckdosen Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(10, 6, "SSD:",0, 'R', 0, 0);
        if($row['EL_SV Steckdosen Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_SV Steckdosen Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        ...
        $pdf->MultiCell(20, 6, "-",0, 'L', 0, 0);
        $pdf->MultiCell(10, 6, "SSD:",0, 'R', 0, 0);
        if($row['EL_USV Steckdosen Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_USV Steckdosen Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(74, 6, "BD:",0, 'R', 0, 0);
        if($row['EL_Bodendose Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Bodendose Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        } 
        ...
        $pdf->SetFont('helvetica', '', 8);
        $pdf->Ln();
        $pdf->MultiCell(74, 6, "DD:",0, 'R', 0, 0);
        if($row['EL_Doppeldatendose Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Doppeldatendose Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(10, 6, "ED:",0, 'R', 0, 0);
        if($row['EL_Einzel-Datendose Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Einzel-Datendose Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->Ln();        
        $pdf->SetFont('helvetica', '', 10);
        $pdf->MultiCell(40, 6, "Beleuchtung:",0, 'R', 0, 0);
        $pdf->SetFont('helvetica', '', 8);
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "",0, 'R', 0, 0);
        $pdf->MultiCell(35, 6, "Dimmbar: " ,0, 'R', 0, 0);
        $pdf->SetFont('zapfdingbats', '', 8);
        if($row['EL_Beleuchtung dimmbar JA/NEIN']==='NEIN'){            
            $pdf->MultiCell(10, 6, TCPDF_FONTS::unichr(54),0, 'L', 0, 0);
        }
        else{
            //grün
        ...
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "",0, 'R', 0, 0);
        $pdf->MultiCell(35, 6, "Bewegungsmelder: " ,0, 'R', 0, 0);
        $pdf->SetFont('zapfdingbats', '', 8);
        if($row['EL_Lichtschaltung BWM JA/NEIN']==='NEIN'){            
            $pdf->MultiCell(10, 6, TCPDF_FONTS::unichr(54),0, 'L', 0, 0);
        }
        else{
            //grün
        ...
        //`EL_Notlicht RZL Stk``EL_Notlicht SL Stk`
        $pdf->Ln();
        $pdf->SetTextColor(0, 0, 0);
        $pdf->SetFont('helvetica', '', 8);
        $pdf->MultiCell(40, 6, "",0, 'R', 0, 0);
        $pdf->MultiCell(35, 6, "Rettungszeichenleuchte: " ,0, 'R', 0, 0);
        if($row['EL_Notlicht RZL Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Notlicht RZL Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "",0, 'R', 0, 0);
        $pdf->MultiCell(35, 6, "Sicherheitsleuchte: " ,0, 'R', 0, 0); 
        if($row['EL_Notlicht SL Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Notlicht SL Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        ...
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "",0, 'R', 0, 0);
        $pdf->MultiCell(35, 6, "Lichtfarbe: " ,0, 'R', 0, 0); 
        if($row['EL_Lichtfarbe K']>0){
            $pdf->MultiCell(20, 6, $row['EL_Lichtfarbe K'] ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        ...
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "",0, 'R', 0, 0);
        $pdf->MultiCell(35, 6, "Leuchten: " ,0, 'R', 0, 0);
        $pdf->Ln();
        ...
        $pdf->Ln();        
        $pdf->SetFont('helvetica', '', 10);
        $pdf->MultiCell(40, 6, "Jalousie:",0, 'R', 0, 0);        
        $pdf->SetFont('helvetica', '', 8);
        $pdf->Ln(); 
        $pdf->MultiCell(40, 6, "",0, 'R', 0, 0); 
        $pdf->MultiCell(30, 6, "Elektrisch:" ,0, 'R', 0, 0);
        $pdf->SetFont('zapfdingbats', '', 8);       
        if($row['EL_Jalousie JA/NEIN']==='NEIN'){            
            $pdf->MultiCell(10, 6, TCPDF_FONTS::unichr(54),0, 'L', 0, 0);
        }
        else{
            //grün
        ...
        $pdf->Ln();        
        $pdf->SetFont('helvetica', '', 10);
        $pdf->MultiCell(40, 6, "Brandmelder:",0, 'R', 0, 0);        
        $pdf->SetFont('helvetica', '', 8);
        $pdf->Ln(); 
        $pdf->MultiCell(40, 6, "",0, 'R', 0, 0); 
        $pdf->MultiCell(30, 6, "Decke: " ,0, 'R', 0, 0);
        $pdf->SetFont('zapfdingbats', '', 8);               
        if($row['EL_Brandmelder Decke JA/NEIN']==='NEIN'){            
            $pdf->MultiCell(10, 6, TCPDF_FONTS::unichr(54),0, 'L', 0, 0);
        }
        else{
            //grün
        ...
        $pdf->SetFont('helvetica', '', 8);
        $pdf->SetTextColor(0, 0, 0);                
        $pdf->MultiCell(50, 6, "Zwischendecke: " ,0, 'R', 0, 0);                
        $pdf->SetFont('zapfdingbats', '', 8);
        if($row['EL_Brandmelder ZwDecke JA/NEIN']==='NEIN'){   
            $pdf->MultiCell(10, 6, TCPDF_FONTS::unichr(54),0, 'L', 0, 0);
        }
        else{
            //grün
        ...
        $pdf->SetFont('helvetica', '', 10);
        $pdf->SetTextColor(0, 0, 0);
        $pdf->MultiCell(40, 6, "Multimedia:",0, 'R', 0, 0);
        $pdf->Ln();
        $pdf->SetFont('helvetica', '', 8);
        $pdf->MultiCell(70, 6, "Kamera:",0, 'R', 0, 0);        
        if($row['EL_Kamera Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Kamera Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(30, 6, "Lautsprecher:",0, 'R', 0, 0); 
        if($row['EL_Lautsprecher Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Lautsprecher Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(70, 6, "Wanduhr:",0, 'R', 0, 0);        
        if($row['EL_Uhr - Wand Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Uhr - Wand Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(30, 6, "Deckenuhr:",0, 'R', 0, 0); 
        if($row['EL_Uhr - Decke Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Uhr - Decke Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(70, 6, "Lichtruf-Terminal:",0, 'R', 0, 0);        
        if($row['EL_Lichtruf - Terminal Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Lichtruf - Terminal Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(30, 6, "Lichtruf-Modul:",0, 'R', 0, 0); 
        if($row['EL_Lichtruf - Steckmodul Stk']>0){
            $pdf->MultiCell(20, 6, $row['EL_Lichtruf - Steckmodul Stk']." Stk" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        ...
        $pdf->MultiCell(20, 6, " ".$row['H6020'],0, 'L', 0, 0);
        $pdf->MultiCell(40, 6, "Kühllast:",0, 'R', 0, 0);
        if($row['HT_Kühllast W']>0){
            $pdf->MultiCell(20, 6, $row['HT_Kühllast W']." W" ,0, 'R', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'R', 0, 0);
        }
        $pdf->MultiCell(40, 6, "Heizlast:",0, 'R', 0, 0);
        if($row['HT_Heizlast W']>0){
            $pdf->MultiCell(20, 6, $row['HT_Heizlast W']." W" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "Raumtemp-Sommer:",0, 'R', 0, 0);
        if($row['HT_Raumtemp Sommer °C']>0){
            $pdf->MultiCell(20, 6, $row['HT_Raumtemp Sommer °C']." °C" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(40, 6, "Kühlung-Lüftung:",0, 'R', 0, 0);
        if($row['HT_Kühlung Lueftung W']>0){
            $pdf->MultiCell(20, 6, $row['HT_Kühlung Lueftung W']." W" ,0, 'R', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'R', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "Raumtemp-Winter:",0, 'R', 0, 0);
        if($row['HT_Raumtemp Winter °C']>0){
            $pdf->MultiCell(20, 6, $row['HT_Raumtemp Winter °C']." °C" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(40, 6, "Kühlung-FB:",0, 'R', 0, 0);
        if($row['HT_Fussbodenkühlung W']>0){
            $pdf->MultiCell(20, 6, $row['HT_Fussbodenkühlung W']." W" ,0, 'R', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'R', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "Luftmenge:",0, 'R', 0, 0);
        if($row['HT_Luftmenge m3/h']>0){
            $pdf->MultiCell(20, 6, $row['HT_Luftmenge m3/h']." m3/h" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(40, 6, "Kühlung-Decke:",0, 'R', 0, 0);
        if($row['HT_Kühldecke W']>0){
            $pdf->MultiCell(20, 6, $row['HT_Kühldecke W']." W" ,0, 'R', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'R', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "Luftwechsel:",0, 'R', 0, 0);
        if($row['HT_Luftwechsel']>0){
            $pdf->MultiCell(20, 6, $row['HT_Luftwechsel']." 1/h" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(40, 6, "Fancoil:",0, 'R', 0, 0);
        if($row['HT_Fancoil W']>0){
            $pdf->MultiCell(20, 6, $row['HT_Fancoil W']." W" ,0, 'R', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'R', 0, 0);
        }
        $pdf->Ln();
        $pdf->MultiCell(40, 6, "Raumvolumen:",0, 'R', 0, 0);
        if($row['Volumen']>0){
            $pdf->MultiCell(20, 6, $row['Volumen']." m3" ,0, 'L', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'L', 0, 0);
        }
        $pdf->MultiCell(40, 6, "Summe Kühlung:",0, 'R', 0, 0);
        if($row['HT_Summe Kühlung W']>0){
            $pdf->MultiCell(20, 6, $row['HT_Summe Kühlung W']." W" ,0, 'R', 0, 0);
        }
        else{
            $pdf->MultiCell(20, 6, "-" ,0, 'R', 0, 0);
        }
        ...
        $pdf->Ln();
        $pdf->SetFont('helvetica', 'B', 10);
        $pdf->MultiCell(50,8, "Architektur-Einrichtung: ",0, 'L', 0, 0);
        $pdf->SetFont('helvetica', '', 10);
        $pdf->Ln();
        if(strlen($row['AR_Ausstattung'])>0){
            ...
            $pdf->MultiCell(40, $rowHeightComment, "",0, 'R', 0, 0);
            $pdf->MultiCell(140, $rowHeightComment, br2nl($row['AR_Ausstattung']),0, 'L', 0, 0);           
        }
        $pdf->Ln();  
    ...
    $pdf->Ln();    
    $pdf->SetFont('helvetica', 'B', 10);
    $pdf->MultiCell(50,8, "Medizintechnik: ",0, 'L', 0, 0);
    $pdf->SetFont('helvetica', '', 10);
    $pdf->Ln(); 
    //$rowHeightFirstLine = $pdf->getStringHeight(50,"ElementID",false,true,'',1);
    /*
    ...
    */
    ...
    while ($row = $result->fetch_assoc()) {
        if($idRoombookEntry != $row['id']){            
            ...
            $bestandsCounter = 1;
            $pdf->SetFont('helvetica', '', 10);
            $rowHeightMainLine = $pdf->getStringHeight(140,$row['Anzahl']." Stk ".$row['ElementID']." - ".$row['Bezeichnung'].", Variante: ".$row['Variante'].", Bestand: ".$bestandsAusgabe,false,true,'',1);
            // Wenn Seitenende? Überprüfen und neue Seite anfangen
            $y = $pdf->GetY();    
            if (($y + $rowHeightMainLine) >= 270) {
                $pdf->AddPage();
            }
            $pdf->MultiCell(40, $rowHeightMainLine, "",0, 'R', 0, 0);
            
            $bestandsAusgabe = "Ja";
            if($row['Neu/Bestand']==1){
                $bestandsAusgabe = "Nein";
            }
            else{
                $bestandsAusgabe = "Ja";
            } 
            $pdf->MultiCell(140, $rowHeightMainLine, $row['Anzahl']." Stk ".$row['Bezeichnung']." - ".$row['ElementID'].", Variante: ".$row['Variante'].", Bestand: ".$bestandsAusgabe,0, 'L', 0, 0);
