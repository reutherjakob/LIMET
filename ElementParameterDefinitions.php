...
$parameterFieldConfig = [
    ...
    'Elektro|Spannung|Einheit' => ["V", "kV", "V DC", ""],
    'Elektro|Nennleistung_min|Einheit' => ["W", "kW", "VA", "kVA", ""],
    'Elektro|Nennleistung_max|Einheit' => ["W", "kW", "VA", "kVA", ""],
    ...
    'Elektro|RJ45 Ports|Wert' => ["Ja", "1", "2", "3", "4", "5", "6", "7", "8", "", "Stk"],
    ...
    'HKLS|Abluftstrom|Einheit' => ["m³/h", "l/s", ""],
    ...
    'HKLS|Zuluftstrom|Einheit' => ["m³/h", "l/s", ""],
    'HKLS|Fortluftstrom|Einheit' => ["m³/h", "l/s", ""],
    ...
    'Allgemein|Leitprodukt|Wert' => ["Ja", "Nein", ""],
    ...
    'Laser|Laserklasse|Wert' => ["1", "2", "3", "4", ""],

    // MedGas (12)
    'MedGas|Stickstoff_Strom|Einheit' => ["l/min", "m³/h", ""],
    'MedGas|Argon_Strom|Einheit' => ["l/min", "m³/h", ""],
    'MedGas|O2 Anschluss|Einheit' => ["DN", "Zoll", '"', ""],
    'MedGas|DL-5 Anschluss|Einheit' => ["DN", "Zoll", '"', ""],
    'MedGas|VAC Anschluss|Einheit' => ["DN", "Zoll", '"', ""],
    'MedGas|DL-10 Anschluss|Einheit' => ["DN", "Zoll", '"', ""],
    'MedGas|NGA Anschluss|Einheit' => ["DN", "Zoll", '"', ""],
    'MedGas|N2O Anschluss|Einheit' => ["DN", "Zoll", '"', ""],
    'MedGas|CO2 Anschluss|Einheit' => ["DN", "Zoll", '"', ""],
