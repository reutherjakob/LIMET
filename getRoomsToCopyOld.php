...
?>
    ...
    <head>
        ...
        <title>RoomToCopyOld4OldBauangabenSeite</title>
    </head>
    <body>
    ...
    $sql = "SELECT tabelle_räume.Raumnr,
            ...
            WHERE ((Not (tabelle_räume.idTABELLE_Räume)=" . $_GET["originRoomID"] . ") AND ((tabelle_projekte.idTABELLE_Projekte)=" . $_SESSION["projectID"] . "));";
