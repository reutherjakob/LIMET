            ...
            <link rel="icon" href="iphone_favicon.png">
                ...
                <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.0/css/bootstrap.min.css">
                    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.0.10/css/all.css" integrity="sha384-+d0P83n9kaQMCwj8F4RJB66tzIwOKmrdb46+porD/OvrJ+37WqIM7UoBtwHO6Nlg" crossorigin="anonymous">
                        ...
                        <!--What has been used till the editor/fixed Columns update-->
<!--                        <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.18/b-1.5.2/b-html5-1.5.2/sl-1.2.6/datatables.min.css"/>
                        ...
                        <!--- Curent Online Version-->
                        <!--                        <link href="https://cdn.datatables.net/v/dt/dt-2.0.3/datatables.min.css" rel="stylesheet"> 
                                                <script type="text/javascript" src="https://cdn.datatables.net/v/dt/dt-2.0.3/datatables.min.js"></script>
                        ...
                        <link rel="stylesheet" text="text/css" href="https://cdn.datatables.net/responsive/3.0.1/css/responsive.dataTables.min.css"/>
                        <script type="text/javascript" src="https://cdn.datatables.net/responsive/3.0.1/js/dataTables.responsive.min.js"></script>  
                        <link rel="stylesheet" text="text/css" href="https://cdn.datatables.net/select/2.0.0/css/select.dataTables.min.css"/>
                        <script type="text/javascript" src="https://cdn.datatables.net/select/2.0.0/js/dataTables.select.min.js"></script>
                        <link rel="stylesheet" text="text/css" href="https://cdn.datatables.net/staterestore/1.4.0/css/stateRestore.dataTables.min.css"/>
                        <script type="text/javascript" src="https://cdn.datatables.net/staterestore/1.4.0/js/dataTables.stateRestore.min.js"></script>
                        <link rel="stylesheet" text="text/css" href="https://cdn.datatables.net/scroller/2.4.1/css/scroller.dataTables.min.css"/>
                        <script type="text/javascript" src="https://cdn.datatables.net/scroller/2.4.1/js/dataTables.scroller.min.js"></script>
...
<script type="text/javascript" src="datatables.min.js"></script> 
                           ...
                           <script type="text/javascript" src="datatables.min.js"></script>    <style>
                            .btn-xs {
                                height: 22px;
                                padding: 2px 5px;
                                font-size: 12px;
                        ...
                        <body style="height:100%">
                            <div class="container-fluid ">
                                ...
                                <!-- Bauangaben-Textfeld & Elemente-Tabelle CONTAINER --> 
                                                                    ...
                                                                    buttons: [
                                                                        {
                                                                            ...
                                                                            text: ' Raum',
                                                                            id: 'DTaddRoom',
                                                                            className: " far fa-plus-square btn buttons_toggle_vis",
                                                                            action: function (e, dt, node, config) {
...
//                                                                        'edit',
                                                                ...
                                                                const columns = table.columns().indexes();//init style adquatly  in  case of tablestatus: saved (columns will stay invisible)
                                                            ...
                                                            function checkAndToggleColumnsVisibility(dt) {
                                                            ...
                                                            function getIndexOfColumn(table, columnName, onlyVisible = true) {
                                                                if (onlyVisible) {
                                                                    const visibleColumn = table.column(columnName + ':visible');
                                                                    return visibleColumn.index();
                                                                } else {
                                                                    const dataColumn = table.column(columnName);
                                                                    console.log(dataColumn.index());
                                                            ...
                                                            function init_DataTable() {
                                                                $('#table_rooms').DataTable({
                                                                    columns: [
                                                                        ...
                                                                        {title: 'MT-rel.', data: 'MT-relevant', name: "MT-rel",
                                                                            render: function (data) {
                                                                                return data === '1' ? 'Ja' : 'Nein';
                                                                            }
                                                                        }, {title: 'Raumbez.', data: 'Raumbezeichnung', name: 'Raumbezeichnung', class: 'editable-text'},
                                                                        {title: 'Raumnr', data: 'Raumnr', name: 'Raumnr'},
                                                                        //RAUMDETAILS
                                                                        ...
                                                                        {title: 'ZSV', data: 'ZSV'},
                                                                        {title: 'USV', data: 'USV'},
                                                                        {title: 'IT', data: 'IT Anbindung', render: function (data) {
                                                                                return data === '1' ? 'Ja' : 'Nein';
                                                                            }},
