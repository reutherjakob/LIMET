    ...
    <div class="mt-4 card">
        ...
        <div class="card-body" id="costsRoomArea">
            ...
            $sql = "SELECT tabelle_räume.`Raumbereich Nutzer`, tabelle_räume.Geschoss, tabelle_räume.Bauabschnitt,  tabelle_räume.Bauetappe
                        FROM tabelle_auftraggeberg_gug RIGHT JOIN 
                            (tabelle_auftraggeber_ghg RIGHT JOIN 
                                (tabelle_auftraggeber_gewerke RIGHT JOIN 
                                    ((tabelle_räume INNER JOIN tabelle_räume_has_tabelle_elemente 
...
<script>
    ...
    $(document).ready(function () {
        ...
        $.ajax({        //Diagramm zeichnen
            ...
            error: function () {
                console.log("Couldnt Load Chart");
            }
        });
    });
