        ...
        // Titelblatt        
            ...
            if($_SESSION["projectAusfuehrung"]==="MADER"){
                ...
                if($_SESSION["projectAusfuehrung"]==="LIMET"){
                    ...
                    $image_file = 'LIMET_web.png';
                    $this->Image($image_file, 140, 40, 30, 13, 'PNG', '', 'M', false, 300, '', false, false, 0, false, false, false);
                    $image_file = 'MADER_Logo.png';
                    $this->Image($image_file, 175, 41, 15, 13, 'PNG', '', 'M', false, 300, '', false, false, 0, false, false, false);
                    $this->SetY(60);
                    $this->SetX(110);                    
...
foreach ($teile as $valueOfRoomID) {
    ...
    while ($row = $result2->fetch_assoc()) { 
        ...
        $pdf->MultiCell(80, 6, "Raumhöhe 2: ".$row['Raumhoehe 2']." m",'B', 'L', 0, 0);         
        $pdf->Ln();
        $pdf->SetFont('helvetica', 'B', 10);
        ...
        if($row['HT_Kühlwasser']==='0'){            
            ...
            if($row['HT_Kühlwasser']==='1'){    
                ...
                $pdf->MultiCell(20, 6, " ".$row['HT_Kühlwasserleistung W']." W",0, 'L', 0, 0);
            }
            else{
                $pdf->SetFont('helvetica', '', 10);
