...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="https://cdn.datatables.net/v/bs4/dt-1.10.18/b-1.5.4/b-colvis-1.5.4/b-flash-1.5.4/b-html5-1.5.4/b-print-1.5.4/r-2.2.2/datatables.min.css"/>
    <script type="text/javascript"
            src="https://cdn.datatables.net/v/bs4/dt-1.10.18/b-1.5.4/b-colvis-1.5.4/b-flash-1.5.4/b-html5-1.5.4/b-print-1.5.4/r-2.2.2/datatables.min.js"></script>
    <!--
...
<div class="container-fluid">
    <div class="mt-4 card">
        ...
        <div class="card-body">
            ...
            echo "</tbody></table>";
            ?>
            <input type='button' id='addContactModalButton' class='btn btn-success btn-sm'
                   value='Lieferantenkontakt hinzufügen' data-toggle='modal' data-target='#addContactModal'></input>
        </div>
    </div>
    <div class='mt-4 row'>
        <div class='col-sm-6'>
            <div class="mt-4 card">
                <div class="card-header">Lieferanten <label class="float-right">
                        <button type='button' id='addLieferantButton' class='btn btn-outline-dark btn-sm'
                                value='addLieferant' data-toggle='modal' data-target='#changeLieferantModal'>Lieferant
                            hinzufügen <i class='far fa-plus-square'></i></button>
                    </label></div>
                <div class="card-body">
                    <?php
                    $mysqli = new mysqli('localhost', $_SESSION["username"], $_SESSION["password"], 'LIMET_RB');
        ...
        <div class='modal fade' id='changeLieferantModal' role='dialog'>
            <div class='modal-dialog modal-md'>
                ...
                <div class='modal-content'>
                    ...
                    <div class='modal-footer'>
                        <input type='button' id='addLieferant' class='btn btn-success btn-sm'
                               value='Hinzufügen'></input>
                        <button type='button' class='btn btn-default btn-sm' data-dismiss='modal'>Abbrechen</button>
                    </div>
                </div>
