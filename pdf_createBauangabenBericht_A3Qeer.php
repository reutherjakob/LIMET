...
$mapping = array("raum_nr_alt" => "raum_nr_neu",
    ...
    "HT_Waermeabgabe alt" => "HT_Waermeabgabe neu",
...
$mp2 = array(//tabelle änderunge => tabelle_räume
    ...
    "Umfang neu" => "Umfang", "Volumen neu" => "Volumen",
    ...
    "ET_Anschlussleistung_AV_W_neu" => "ET_Anschlussleistund_AV_W",
    ...
    "HT_Waermeabgabe neu" => "HT_Waermeabgabe_W",
    "O2 neu" => "O2",
    "VA neu" => "Va",
    "DL-5 neu" => "DL-5",
    "H2 neu" => "H2",
...
foreach ($roomIDsArray as $valueOfRoomID) {
    ...
    while ($row = $result_rooms->fetch_assoc()) {
        ...
        //        foreach ($parameter_changes_t_räume as $item) { //FORENSICS
        //            $pdf->MultiCell($e_C, 6, $item, 0, 'R', 0, 1);
        //        }
