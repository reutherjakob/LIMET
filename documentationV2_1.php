                  ...
                  <?php 
                        if($_SESSION["ext"]==0){
                            echo "<a class='dropdown-item' href='projectParticipants.php'><i class='fa fa-users'></i> Projektbeteiligte</a>
                                  <a class='dropdown-item active' href='documentationV2.php'><i class='fa fa-comments'></i> Dokumentation</a>";
                        }
                    ?>
              </ul>
            </li>
            ...
            <div class="mt-4 card">
                    <div class="card-header"><b>Vermerkgruppen</b>
                        <label class="float-right">
                            <button type='button' id='<?php echo $_SESSION["projectID"] ?>' class='btn btn-outline-success btn-sm' value='Neue Vermerkgruppe'><i class='fas fa-plus'></i> Neu</button>
                            <button type="button" class="btn btn-outline-dark btn-sm" value="searchDocumentation" data-toggle="modal" data-target="#showSearchModal"><i class="fas fa-search"></i> Suche</button> 
                        </label>
                    </div>
                    <div class="card-body">                                        
                                        <?php
                                                ...
                                                echo "<table class='table table-striped table-bordered table-sm' id='tableVermerkGruppe'  cellspacing='0' width='100%'>
                                                        <thead><tr>
                                                        <th>ID</th>
                                                        <th></th>
                                                        <th>Name</th>
            ...
            <div class="mt-4 card">
                    <div class="card-header"><b>Vermerkuntergruppen</b>
                        <label class="float-right" id="divUntergruppeRightLabel">
                            <button type='button' id='buttonNewVermerkuntergruppe' class='btn btn-outline-success btn-sm' value='Neue Vermerkuntergruppe' style='visibility:hidden'><i class='fas fa-plus'></i> Neu</button>
                        </label>
                    </div>
            ...
            <div class="mt-4 card">
                    <div class="card-header"><b>Vermerke</b>
                        <label class="float-right" id="divVermerkeRightLabel">
                            <button type='button' id='buttonNewVermerk' class='btn btn-outline-success btn-sm' value='Neuer Vermerk' style='visibility:hidden'><i class='fas fa-plus'></i> Neu</button>
                        </label>
                    </div>
	    ...
	    <div class='modal-dialog modal-md'>	    
	      ...
	      <div class='modal-content'>
	        ...
	        <div class='modal-body' id='mbody'>
                        <form role="form">        			        			        		
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-sm" id="gruppenDatum" placeholder="jjjj.mm.tt"/>
                            </div>
                            <div class="form-group">
                              <label for="gruppenStart">Startzeit:</label>
                              <input type="text" class="form-control form-control-sm" id="gruppenStart" placeholder="hh:mm"/>
                            </div>
                            <div class="form-group">
                              <label for="gruppenEnde">Endzeit:</label>
                              <input type="text" class="form-control form-control-sm" id="gruppenEnde" placeholder="hh:mm"/>
                            </div>
                            <?php
                                /*
                                echo "<div class='form-group'>
                                <label for='gruppenFortsetzung'>Fortsetzung von:</label>									
                                    <select class='form-control input-sm' id='gruppenFortsetzung' name='gruppenFortsetzung'>";
                                        echo "<option value=0 selected>Keine Fortsetzung</option>";
                                        foreach($vermerkGruppenImProjekt as $array) {                                                    
                                                echo "<option value=".$array['idtabelle_Vermerkgruppe'].">".$array['Datum']."-".$array['Gruppenname']."</option>";
                                        }	
                                    echo "</select>	
                                </div>";                                                                                                                 
                                 * 
	        ...
	        <div class='modal-footer'>
                        <input type='button' id='addGroup' class='btn btn-success btn-sm' value='HinzufÃ¼gen' data-dismiss='modal'></input>
                        <input type='button' id='saveGroup' class='btn btn-warning btn-sm' value='Speichern' data-dismiss='modal'></input>
        ...
        if(gruppenart !== "" && gruppenName !== "" && gruppenOrt !== "" && gruppenVerfasser !== "" && gruppenDatum !== "" && gruppenStart !== "" && gruppenEnde !== ""){
           // $('#addDeviceModal').modal('hide');
            ...
            $.ajax({
                ...
                data:{"gruppenart":gruppenart,"gruppenName":gruppenName,"gruppenOrt":gruppenOrt,"gruppenVerfasser":gruppenVerfasser,"gruppenDatum":gruppenDatum,"gruppenStart":gruppenStart,"gruppenEnde":gruppenEnde},
                type: "GET",	        
                success: function(data){
                    alert(data);
        ...
        if(gruppenart !== "" && gruppenName !== "" && gruppenOrt !== "" && gruppenVerfasser !== "" && gruppenDatum !== "" && gruppenStart !== "" && gruppenEnde !== "" && gruppenID !== ""){
           // $('#addDeviceModal').modal('hide');
            ...
            $.ajax({
                ...
                data:{"gruppenart":gruppenart,"gruppenName":gruppenName,"gruppenOrt":gruppenOrt,"gruppenVerfasser":gruppenVerfasser,"gruppenDatum":gruppenDatum,"gruppenStart":gruppenStart,"gruppenEnde":gruppenEnde,"gruppenID":gruppenID},
                type: "GET",	        
                success: function(data){
                    alert(data);
                    // Neu Laden der Vermerkliste
